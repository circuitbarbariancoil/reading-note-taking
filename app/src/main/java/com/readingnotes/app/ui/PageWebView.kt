...
fun PageWebView(
    ...
    val html = PageHtml.render(page, colors, vertical, interactive = interactive, flash = flash, flashExcerpt = flashExcerpt)
    ...
    AndroidView(
        ...
        update = { web ->
            ...
            val contentKey = "${page.page}|${page.ocrText?.hashCode()}|$vertical|$interactive|$flash|$flashExcerpt"
